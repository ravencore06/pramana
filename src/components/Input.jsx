  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          id={id}
          className={`w-full ${Icon ? "pl-9" : "pl-3"} pr-3 py-2.5 text-sm border rounded-xl bg-white focus:border-[#2563EB] focus:ring-2 focus:ring-blue-100 transition-all outline-none ${
