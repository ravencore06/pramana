        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="bg-[#800000] px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-red-100">Maharaj Vijayaram Gajapathi Raj College of Engineering</p>
                  </div>
                </div>
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div className="text-center pb-4 border-b border-slate-200">
                  <h3 className="text-xl font-bold text-[#800000]">Degree Certificate</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.studentName}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">Student ID</p>
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.studentId}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">Department</p>
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.department}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">Degree</p>
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.degree}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">CGPA</p>
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.cgpa} / 10.0</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">Issue Date</p>
                    <p className="text-base font-semibold text-[#1E293B] mt-0.5">{cert.issueDate}</p>
                  </div>
                </div>
                ...
                <div className="border-t border-slate-200 pt-4 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="text-left">
                      ...
                      <div className="w-28 h-0.5 bg-[#800000] mt-1" />
                    ...
                    <div className="text-left">
                      ...
                      <div className="mt-1 w-10 h-10 rounded-full border-2 border-[#800000] flex items-center justify-center">
                        <GraduationCap size={14} className="text-[#800000]" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
              <h4 className="text-sm font-semibold text-[#1E293B] mb-3">Actions</h4>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col items-center">
              <h4 className="text-sm font-semibold text-[#1E293B] mb-3 w-full text-left">Verification QR</h4>
